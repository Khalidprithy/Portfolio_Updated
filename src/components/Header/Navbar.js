            ...
            <div
                ...
                <div className=" text-white">
                    <div className="dropdown">
                        <span tabIndex="0" className=" text-2xl md:text-4xl text-accent px-2 md:px-10 ml-1">Dev.Kbin</span>
                ...
                <div className={` ${open ? "hidden md:block ease-in-out duration-500" : "hidden"} `}>
                    <ul className="menu menu-horizontal p-0">
                        <ul className="menu menu-horizontal p-0">
                            ...
                            <Link to='/project'><p className='text-2xl px-2 text-white font-semibold hover:text-accent'>Project</p></Link>

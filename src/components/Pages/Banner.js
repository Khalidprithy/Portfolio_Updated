            ...
            <div
                ...
                >
                    <div className="max-w-md text-white p-2">
                        ...
                        <p className="py-6 px-2 text-base md:text-2xl">MERN stack Developer. I have experience working with HTML5, CSS3, JavaScript, ES6, Bootstrap, Tailwind, Node.js, and MongoDB. I can work with Figma and Adobe XD. I have built a few Full-stack applications. At this moment, I am seeking a professional working environment to help build real-life applications and grow as a web developer</p>
                        <a
                            href='#contactMe'

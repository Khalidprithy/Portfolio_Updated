...
const Footer = () => {
    return (
        <div className='mx-1 md:mx-4'>
            <footer className="flex items-center justify-between bg-neutral m-3 mx-auto h-24 w-12/12 md:w-1/2 hover:w-full ease-in-out duration-500 rounded-xl text-white">

                <div className="items-center grid-flow-col mx-2">
                    <p className='text-white text-xl'>Copyright © Dev.Kbin</p>
                </div>
